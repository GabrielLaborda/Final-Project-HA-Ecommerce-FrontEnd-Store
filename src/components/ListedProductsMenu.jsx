  ...
  return (
      <div className="w-100">
        <ul className='px-0'>
          ...
          <li className='p-0 m-0'><NavLink className={'text-decoration-none'} to={'/products/decks'} style={navLinkStyles}>
            DECKS
          </NavLink></li>
          <li className='p-0 m-0'><NavLink className={'text-decoration-none'} to={'/products/trucks'} style={navLinkStyles}>
            TRUCKS
          </NavLink></li>
          <li className='p-0 m-0'><NavLink className={'text-decoration-none'} to={'/products/wheels'} style={navLinkStyles}>
          WHEELS
          </NavLink></li>
        </ul>
      </div>
